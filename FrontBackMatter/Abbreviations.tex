...
\textbf{AWS S3} & \textbf{A}mazon \textbf{W}eb \textbf{S}ervices \textbf{S}imple \textbf{S}torage \textbf{S}ervice \\
\textbf{CRUD} & \textbf{C}reate, \textbf{R}ead, \textbf{U}pdate, \textbf{D}elete \\
\textbf{FFmpeg} & \textbf{F}ast \textbf{F}orward MPEG --- мультимедиа боловсруулалтын нээлттэй хэрэгсэл \\
